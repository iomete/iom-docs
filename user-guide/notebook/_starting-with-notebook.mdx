...
P.S: We recommend to use Visual Studio Code as your Jupyter Client. For more information read [this](/user-guide/notebook/using-jupyterlab).
...
<Card
  ...
  icon={<CodeBlock />}
  link="user-guide/notebook/using-jupyterlab"
>
