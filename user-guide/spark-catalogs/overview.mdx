...
For authentication, a session or a [PAT token](../access-tokens/personal.md) is required.
...
<Img
  src="/img/user-guide/spark-catalogs/admin-spark-catalogs.png"
  alt="Spark Catalogs in Admin Portal"
/>
...
Check out the `SQL Editor` section in the left panel. If you don't see the created catalog, please refresh by using the <ArrowsClockwise size={16} /> button.
