...
The defaults work well for most workloads, but you can override them globally, per [Spark job](../spark-jobs/spark-application-config.md), or per [compute cluster](/user-guide/compute-clusters/overview).
