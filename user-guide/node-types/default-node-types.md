...
| driver-x-large | Driver | ~8 vCPU | ~61 GiB | No | x-large (8vCPU/64GB) |
...
| Name | Component | CPU | Memory | Description |
| --- | --- | --- | --- | --- |
| driver-small | Driver | ~2 vCPU | ~9 GiB | e2-highmem-2 (2vCPU/16GB) |
...
| --- | --- | --- |
| driver-small | Driver | small (2vCPU/8GB) |
| driver-medium | Driver | medium (2vCPU/16GB) |
| driver-large | Driver | large (4vCPU/32GB) |
| driver-x-large | Driver | x-large (8vCPU/64GB) |
