...
:::tip Discover IOMETE
Learn how IOMETE provides a modern alternative to Databricks:
- [What is IOMETE](/docs/getting-started/what-is-iomete) - Platform introduction
- [Platform Architecture](/docs/getting-started/architecture) - Technical overview
- [Virtual Lakehouses](/docs/user-guide/virtual-lakehouses) - Flexible compute isolation
- [Platform Tour](/docs/getting-started/platform-tour) - Explore the features
:::
...
:::info Next Steps
Get started with IOMETE:
- [Community Deployment](/docs/community-deployment/overview) - Free self-hosted option
- [Spark Jobs Guide](/docs/developer-guide/spark-job/getting-started) - Build data pipelines
- [Scalability](/docs/getting-started/scalability) - Scale your data workloads
:::
