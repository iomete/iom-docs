...
To setup Airflow locally you can use [docker-compose file](https://github.com/iomete/iomete-airflow-plugin/blob/main/docker-compose.yaml).  
Download it to your local machine and run the following command:

```bash
docker-compose up --build
```

It will start Airflow webserver on http://localhost:8080. May take couple of minutes to start.

### Install IOMETE Airflow Plugin
