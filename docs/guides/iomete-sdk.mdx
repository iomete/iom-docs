...
Workspace ID can be found in the **Workspace Settings** page of the IOMETE platform.

<ImgBorder src="/img/spark-job/workspace-id.png" alt="Workspace ID" />
...
For example, both  
`https://api.iomete.com/api/v1/workspaces/pceh7-816/jobs/{job_id}` and  
`https://api.iomete.com/api/v1/workspaces/pceh7-816/jobs/{job_name}`
...
```bash
curl --location --request PUT 'https://api.iomete.com/api/v1/workspaces/pceh7-816/jobs/test-job' \
--header 'Authorization: Bearer TEST_TOKEN' \
--header 'Content-Type: application/json' \
--data-raw '{
    "name": "test-job",
...
```bash
curl --location --request DELETE 'https://api.iomete.com/api/v1/workspaces/pceh7-816/jobs/test-job' \
--header 'Authorization: Bearer TEST_TOKEN'
```
...
```bash
curl --location --request POST 'https://api.iomete.com/api/v1/workspaces/pceh7-816/jobs/test-job/runs' \
--header 'Authorization: Bearer TEST_TOKEN' \
--header 'Content-Type: application/json' \
--data-raw '{}'
```
...
```bash
curl --location --request GET 'https://api.iomete.com/api/v1/workspaces/pceh7-816/jobs/test-job/runs' \
--header 'Authorization: Bearer TEST_TOKEN'
```
...
```bash
curl --location --request POST 'https://api.iomete.com/api/v1/workspaces/pceh7-816/jobs/test-job/runs/{run_id}/cancel' \
--header 'Authorization: Bearer TEST_TOKEN'
```
