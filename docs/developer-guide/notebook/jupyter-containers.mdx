...
- **[Node types](/user-guide/node-types/overview)**: Determine CPU and memory allocation.
...
- **[Compute clusters](/user-guide/compute-clusters/overview)**: Provide Spark Connect endpoints for distributed processing.
