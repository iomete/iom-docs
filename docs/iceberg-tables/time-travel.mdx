...
import { GithubLogo, CodeBlock, ClockCountdown } from "@phosphor-icons/react";
...
<ImgBorder src="/img/iceberg/table-history.png" alt="Table history" />
...
<ImgBorder src="/img/iceberg/time-travelled.png" alt="Time travel result" />
