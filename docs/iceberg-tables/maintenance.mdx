...
See the [Iceberg Procedures - Expire Snapshots](/docs/iceberg-tables/iceberg-procedures#expire_snapshots) for available options.
...
[Iceberg Procedures - Remove orphan files](/docs/iceberg-tables/iceberg-procedures#remove_orphan_files) - to see more configuration options.
...
[Iceberg Procedures - Rewrite data files](/docs/iceberg-tables/iceberg-procedures#rewrite_data_files) - to see more configuration options.
...
[Iceberg Procedures - Rewrite manifests](/docs/iceberg-tables/iceberg-procedures#rewrite_manifests) - to see more configuration options.
