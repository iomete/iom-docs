---
title: "Iceberg Spark Procedures for Snapshot and Metadata Management"
...
Many maintenance actions can be performed using Iceberg stored procedures. [Data Compaction Job](https://iomete.com/docs/iomete-spark-job/data-compaction-job) 
