...
<Release version="TBD" date="TBD">
  <Improvements>
    - **Resource Bundle Filter for Spark Applications**: The Spark Applications page now supports filtering by resource bundle, matching the filter already available on Job Templates and Streaming Jobs.
  </Improvements>
</Release>
