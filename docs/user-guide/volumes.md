...
Let's navigate to the [Lakehouse create](./virtual-lakehouses.md#creating-a-cluster) page. Here, you'll find options for `Volume` which include volume selections.
