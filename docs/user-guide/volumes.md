...
Let's navigate to the [Lakehouse create](./virtual-lakehouses.md#creating-a-compute-cluster) page. Here, you'l find options for `Volume` which include volume selections.
