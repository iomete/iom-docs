...
| :------------------ | :--------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------- |
| **List Catalogs**   | `GET /api/v1/domains/{domain}/schema/catalogs`                                                             | _No change (Stays on V1)_                                                                                      |
...
| :------------------ | :--------------------------------------------------------------------------- | :------------------------------------------------------------------------------- |
| **List Catalogs**   | `GET /api/v1/admin/schema/catalogs`                                          | _No change (Stays on V1)_                                                        |
...
3.  **Enable On-Demand Refresh:** Optionally incorporate the `forceRefresh` parameter into your application's metadata synchronization logic to allow users to bypass cached data and retrieve live schema updates.
