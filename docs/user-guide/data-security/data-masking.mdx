...
| `substr(credit_card, 1, 4) \|\| '-XXXX-XXXX-' \|\| substr(credit_card, -4)` | Keep first and last 4 digits of a credit card |
...
| `contains({col}, 'test')`    | Apply mask when value contains "test"    |
