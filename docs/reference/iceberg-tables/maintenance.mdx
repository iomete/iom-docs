...
See the [Iceberg Procedures - Expire Snapshots](/reference/iceberg-tables/iceberg-procedures#expire_snapshots) for available options.
...
[Iceberg Procedures - Remove orphan files](/reference/iceberg-tables/iceberg-procedures#remove_orphan_files) - to see more configuration options.
...
[Iceberg Procedures - Rewrite data files](/reference/iceberg-tables/iceberg-procedures#rewrite_data_files) - to see more configuration options.
...
[Iceberg Procedures - Rewrite manifests](/reference/iceberg-tables/iceberg-procedures#rewrite_manifests) - to see more configuration options.
