...
| Argument Name | Required? | Type   | Description                           |
| ------------- | --------- | ------ | ------------------------------------- |
| `table`       | ✔️        | string | Name of the table to publish to       |
| `wap_id`      | ✔️        | string | The WAP ID of the staged changes      |
...
| Argument Name | Required? | Type   | Description                                     |
| ------------- | --------- | ------ | ----------------------------------------------- |
| `table`       | ✔️        | string | Name of the table containing the branches       |
| `branch`      | ✔️        | string | Name of the branch to fast-forward              |
| `to`          | ✔️        | string | Name of the branch to fast-forward to           |
...
| Argument Name   | Required? | Type   | Description                                                  |
| --------------- | --------- | ------ | ------------------------------------------------------------ |
| `table`         | ✔️        | string | Name to register the table as                                |
| `metadata_file` | ✔️        | string | Path to the Iceberg metadata file for the table              |
...
| Argument Name        | Required? | Type       | Description                                                                                                            |
| -------------------- | --------- | ---------- | ---------------------------------------------------------------------------------------------------------------------- |
| `table`              | ✔️        | string     | Name of the source table                                                                                               |
