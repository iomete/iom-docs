...
:::tip
See: [JDBC-sources doc](/user-guide/reference/data-sources/jdbc-sources)
:::
...
:::tip
See: [CSV Files doc](/user-guide/reference/data-sources/csv-files)
:::
...
:::tip
See: [JSON Files doc](/user-guide/reference/data-sources/json-files)
:::
...
:::tip
See: [Parquet Files doc](/user-guide/reference/data-sources/parquet-files)
:::
...
:::tip
See: [Orc Files doc](/user-guide/reference/data-sources/orc-files)
:::
