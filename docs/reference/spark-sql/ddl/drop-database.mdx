---
title: Drop Database
description: Learn how to drop a database and associated directory in the file system with this tutorial. Syntax, parameters, and examples included.
slug: /reference/spark-sql/drop-database
last_update:
  date: 10/04/2022
