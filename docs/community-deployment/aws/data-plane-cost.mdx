...
<Img src="/img/guides/deployments/aws/data-plane-cost/data-plane-overview.png"
     alt="AWS - Data Plane Overview" caption="AWS - Data Plane Overview"/>
...
- **EKS**: AWS charges approximately *$72/month* for an EKS cluster. Refer to the [AWS EKS pricing page](https://aws.amazon.com/eks/pricing/) for more details.
...
:::important
The Lakehouse cluster driver should be operational at all times as it acts as the endpoint for BI tools. The executors are elastic and can be scaled up or down according to the load. Learn more about the [Lakehouse cluster](/docs/user-guide/virtual-lakehouses).
:::
...
<Img src="/img/guides/deployments/aws/data-plane-cost/cost-allocation-tags.png"
     alt="Cost allocation tags" caption="Cost allocation tags"/>
...
<Img src="/img/guides/deployments/aws/data-plane-cost/cost-explorer-tag.png"
     alt="Cost allocation tags" caption="Cost allocation tags"/>
