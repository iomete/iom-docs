...
## **v1.6.0**: The first Community Version for AWS 💰

**🎉 Announcement**

We're excited to announce the first community version of IOMETE for AWS. This version is free to use and includes all the major features of the Enterprise version. Community version is self-hosted and self-supported. For fully-managed support, please contact us at support@iomete.com
