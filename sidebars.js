            ...
            items: [
                "deployment/community-deployment",
                {
                    ...
                    items: [
                        ...
                        "deployment/aws/upgrade",
                        "deployment/aws/changelog",
                        "deployment/aws/permissions",
                        "deployment/aws/data-plane-cost",
                    ],
                },
                {
                    type: "category",
                    label: "Azure",
                    collapsed: true,
                    items: ["deployment/azure/install", "deployment/azure/upgrade"],
                },
                {
                    type: "category",
                    label: "GCP",
                    collapsed: true,
                    items: ["deployment/gcp/install", "deployment/gcp/upgrade"],
                },
                {
                    type: "category",
                    label: "On-Premise",
                    collapsed: true,
                    items: ["deployment/on-prem/life-cycle-management"],
                },
            ],
        },
    ],
