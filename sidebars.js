  ...
  guides: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            "user-guide/data-catalog/overview",
            "user-guide/data-catalog/search",
            "user-guide/data-catalog/data-explorer",
            "user-guide/data-catalog/favorites",
            "user-guide/data-catalog/table-details",
            "user-guide/data-catalog/classification-tags",
            "user-guide/data-catalog/access-permissions",
          ],
        },
        "user-guide/create-a-personal-access-token",
        "user-guide/global-spark-settings",
        "user-guide/private-docker-registry",
        "user-guide/docker-tag-aliases",
        "user-guide/email-settings",
        {
          ...
          collapsed: true,
          items: [
            "user-guide/node-types/overview",
            "user-guide/node-types/spark-resource-selection",
            "user-guide/node-types/internal-implementation",
            "user-guide/node-types/default-node-types",
            "user-guide/node-types/performance-benchmarking",
            "user-guide/node-types/node-type-sizing",
          ],
        },
        "user-guide/volumes",
        "user-guide/secrets",
