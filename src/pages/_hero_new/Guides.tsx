...
function Guides() {
  return (
    <div className={style.Guides}>
      ...
      <div className={`${style.GuidesCards} row`}>
        <div className="col col--12">
          <div className={`${style.Card} card`}>
            <div className={`${style.MainCardContent} card__body`}>
              <div>
              ...
              <div className={style.MainCardMedia}>
                <svg
                  width="56"
                  height="56"
                  viewBox="0 0 56 56"
        ...
        {guides.map((guide, index) => (
          <div className="col col--3" key={index}>
            <div className={`${style.GuideCard} card`}>
              <div className={style.GuideHeader}>{guide.icon}</div>
