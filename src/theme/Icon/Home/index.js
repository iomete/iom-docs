/**
 * Swizzled (override) of @theme/Icon/Home.
 * Renders the IOMETE breadcrumb "home" icon. Sizing/color come from the
 * className passed by DocBreadcrumbs (see .breadcrumbHomeIcon), so we keep
 * the SVG responsive and use currentColor for stroke.
 */
